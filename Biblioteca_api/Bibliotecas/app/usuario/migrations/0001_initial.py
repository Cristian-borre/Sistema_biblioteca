    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documento', models.BigIntegerField(db_column='documento', primary_key=True, serialize=False)),
                ...
                ('cargo', models.IntegerField(choices=[(1, 'admin'), (2, 'empleado'), (3, 'natural')], db_column='cargo')),
