...
<div class="ml-0 md:ml-[240px]">
    ...
    <div class="mt-4 md:p-2 lg:p-4 xl:p-10">
        <button type="button" class="bg-blue-600 hover:bg-blue-700 ml-10 md:ml-8 xl:ml-18 2xl:ml-20 text-white px-4 py-2 font-semibold rounded-lg" data-toggle="modal" data-target="#AddModal" data-bs-whatever="@mdo">Nuevo Editorial</button>
                    ...
                    <form action="./addeditorialcontroller" method="POST">
                        <div class="fields">
                            ...
                            <div class="inputs mb-2">
                                ...
                                <input type="text" class="form-control text-dark" id="editorial" name="editorial" required>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form action="./editeditorialcontroller" method="POST">
                        <div class="fields">
                            ...
                            <div class="inputs mb-2">
                                <label class="col-form-label">Editorial:</label>
                                <input type="text" class="editorial form-control text-dark" id="editorial" name="editorial" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" class="form-control" id="token" name="token" value="<?php echo $_SESSION['token'] ?>" required>
