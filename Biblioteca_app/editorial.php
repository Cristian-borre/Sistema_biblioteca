...
<div class="ml-0 md:ml-[240px]">
    <div class="bg-[#1E1A34] w-full h-16 shadow-xl border-l-2 border-b-2 border-gray-400 grid place-items-center text-2xl font-semibold text-white">Lista de Editoriales</div>
    <div class="mt-4 md:p-2 lg:p-4 xl:p-10 h-[620px]">
        <button type="button" class="bg-blue-600 hover:bg-blue-700 ml-10 md:ml-8 xl:ml-18 2xl:ml-20 text-white px-4 py-2 font-semibold rounded-lg" id="Addmodal">Nuevo Editorial</button>
                    ...
                    <tbody>
                        ...
                        if ($editorial['message'] == 'Editoriales listados') {
                            foreach ($editorial['data'] as $editorial) { ?>
                                <tr>
                                    <form>
                                        <td class="p-4 text-base border border-gray-300 font-semibold text-gray-800 font-bold"><?php echo $editorial['id'] ?></td>
                                        <td class="p-4 text-base border border-gray-300 font-semibold text-gray-800"><?php echo $editorial['editorial'] ?></td>
                                        ...
                                        <td class="text-center border border-gray-300">
                                            <?php
                                            if ($editorial['estado']) { ?>
                                                <a href="./deleteeditorialcontroller?id=<?php echo $editorial['id'] ?>&jwt=<?php echo $_SESSION['token'] ?>" class="py-1 px-3 rounded-lg bg-red-600 hover:bg-red-700 text-lg text-white bx bx-trash"></a>
                                            <?php } else { ?>
                                                <a href="./deleteeditorialcontroller?id=<?php echo $editorial['id'] ?>&jwt=<?php echo $_SESSION['token'] ?>" class="py-1 px-3 rounded-lg bg-green-500 hover:bg-green-600 text-lg text-white bx bx-refresh"></a>
                                            <?php } ?>
                                        </td>
                                    </form>
                                </tr>
        ...
        <div class="bg-white rounded-lg p-8 w-74 md:w-full max-w-2xl max-h-full">
            <div>
                <div class="flex justify-between h-10 border-b border-gray-300 mb-4">
                    <h5 class="font-semibold text-2xl" id="exampleModalLabel">Nuevo Editorial</h5>
                ...
                <div>
                    <form action="./addeditorialcontroller" method="POST">
                        <div>
                            ...
                            <div class="w-full mb-4">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="editorial">
                                    Editorial:
                                </label>
                                <input id="editorial" name="editorial" required class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:border-blue-500" type="text">
                            </div>
                        </div>
    ...
    <div id="EditModal" tabindex="-1" aria-hidden="true" class="fixed inset-0 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg p-8 w-72 md:w-full max-w-2xl max-h-full">
            <div>
                <div class="flex justify-between h-10 border-b border-gray-300 mb-4">
                    <h5 class="font-semibold text-2xl" id="exampleModalLabel">Editar Editorial</h5>
                ...
                <div class="modal-body">
                    <form action="./editeditorialcontroller" method="POST">
                        <div>
                            <div class="w-full mb-4">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="id">
                                    ID:
                            ...
                            <div class="w-full mb-4">
                                ...
                                <input id="editorial" name="editorial" required class="editorial appearance-none block w-full text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:border-blue-500" type="text">
                            </div>
                        </div>
                        <div class="flex justify-end border-t border-gray-300 pt-4">
                            <input type="hidden" class="form-control text-dark" id="token" name="token" value="<?php echo $_SESSION['token'] ?>" required>
