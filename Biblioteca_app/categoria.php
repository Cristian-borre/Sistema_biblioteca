...
<div class="ml-0 md:ml-[240px]">
    ...
    <div class="mt-4 md:p-2 lg:p-4 xl:p-10 h-[620px]">
        <button type="button" class="bg-blue-600 hover:bg-blue-700 ml-10 md:ml-8 xl:ml-18 2xl:ml-20 text-white px-4 py-2 font-semibold rounded-lg" id="Addmodal">Nueva Categoria</button>
        ...
        <div class="bg-white rounded-lg p-8 w-74 md:w-full max-w-2xl max-h-full">
            <div>
                <div class="flex justify-between h-10 border-b border-gray-300 mb-4">
                    <h5 class="font-semibold text-2xl" id="exampleModalLabel">Nueva Categoria</h5>
                    ...
                    <form action="./addcategoriacontroller" method="POST">
                        <div>
                            ...
                            <div class="w-full mb-4">
                                ...
                                <input id="categoria" name="categoria" required class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:border-blue-500" type="text">
                            </div>
                        </div>
    ...
    <div id="EditModal" tabindex="-1" aria-hidden="true" class="fixed inset-0 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg p-8 w-74 md:w-full max-w-2xl max-h-full">
            <div>
                <div class="flex justify-between h-10 border-b border-gray-300 mb-4">
                    <h5 class="font-semibold text-2xl" id="exampleModalLabel">Editar Categoria</h5>
                    ...
                    <form action="./editcategoriacontroller" method="POST">
                        <div>
                            ...
                            <div class="w-full mb-4">
                                ...
                                <input id="categoria" name="categoria" required class="categoria appearance-none block w-full text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:border-blue-500" type="text">
                            </div>
                        </div>
                        <div class="flex justify-end border-t border-gray-300 pt-4">
                            <input type="hidden" class="form-control text-dark" id="token" name="token" value="<?php echo $_SESSION['token'] ?>" required>
