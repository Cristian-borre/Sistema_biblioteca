    ...
    <div class="container mt-3">
        <div class="">
            <div class="container col-xl-13">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-bs-whatever="@mdo">Nuevo Autor</button>
                <div id="menu_tabla_ingresos" class="header text-center text-dark">Lista de Autores </div>
                <br>
                <table class="table table-bordered" id="tabla_ingresos">
                    ...
                    <tbody>
                        ...
                        <form class="form-inline" method="POST" action="#">
                            ...
                            <td class="text-center"><?php echo $autor['autor'] ?></td>
                            ...
                            <td class="text-center">
                                <?php
                                    if($autor['estado']){ ?>
                                        <a href="./deleteautorescontroller?id=<?php echo $autor['id']?>&jwt=<?php echo $_SESSION['token']?>" class="btn btn-success bx bx-user-check"></a>
                                <?php }else{ ?>
                                        <a href="./deleteautorescontroller?id=<?php echo $autor['id']?>&jwt=<?php echo $_SESSION['token']?>" class="btn btn-danger bx bx-user-x"></a>
                                <?php } ?>
                            </td>
                        </form>
                        </tr>
                                ...
                                <form action="./addautorescontroller" method="POST">
                                    <div class="fields">
                                        ...
                                        <div class="inputs mb-2">
                                            ...
                                            <input type="text" class="form-control text-dark" id="autor" name="autor" required>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-body">
                                <form action="./editautorescontroller" method="POST">
                                    <div class="fields">
                                        ...
                                        <div class="inputs mb-2">
                                            <label class="col-form-label">Autor:</label>
                                            <input type="text" class="autor form-control text-dark" id="autor" name="autor" required>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <input type="hidden" class="form-control" id="token" name="token" value="<?php echo $_SESSION['token'] ?>" required>
